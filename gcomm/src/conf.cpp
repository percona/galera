...
#define GCOMM_CONF_ADD_DEFAULT(_x_) cnf.add(_x_, Defaults::_x_, Flags::_x_);
    ...
    GCOMM_CONF_ADD_DEFAULT(GMCastMCastTTL);
    GCOMM_CONF_ADD        (GMCastMCastAddr);
    GCOMM_CONF_ADD_DEFAULT(GMCastTimeWait);
    GCOMM_CONF_ADD_DEFAULT(GMCastPeerTimeout);
    ...
    GCOMM_CONF_ADD_DEFAULT(EvsVersion);
    ...
    GCOMM_CONF_ADD_DEFAULT(EvsKeepalivePeriod);
    GCOMM_CONF_ADD_DEFAULT(EvsJoinRetransPeriod);
    GCOMM_CONF_ADD_DEFAULT(EvsStatsReportPeriod);
    GCOMM_CONF_ADD_DEFAULT(EvsDebugLogMask);
    GCOMM_CONF_ADD_DEFAULT(EvsInfoLogMask);
    GCOMM_CONF_ADD_DEFAULT(EvsSendWindow);
    GCOMM_CONF_ADD_DEFAULT(EvsUserSendWindow);
    GCOMM_CONF_ADD_DEFAULT(EvsUseAggregate);
    GCOMM_CONF_ADD_DEFAULT(EvsCausalKeepalivePeriod);
    ...
    GCOMM_CONF_ADD_DEFAULT(PcLinger);
